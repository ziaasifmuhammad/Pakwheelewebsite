...
const page = () => {
    return (
        <div className="justify-center items-center text-center">
            <img src="./wcar.jpg" alt="car" className="h-100 w-100 text-center place-items-center px-20 "></img>
            ...
            <p className="text-center items-center font-normal py-4 px-5">PKR 4500,000</p>
